import { createEffect, createMemo, createSignal, onCleanup, type Ref } from "solid-js"
...
function ClinicalResearchTabIcon() {
  return <img src={clinicalResearchIcon} alt="" aria-hidden="true" class="size-4 shrink-0 rounded-[3px] object-cover" />
}
