...
import "./styles.css"
import clinicalResearchIcon from "./clinical-research-workbench-icon.png"
...
function LoadingSplash() {
  return (
    <div class="h-dvh w-screen flex flex-col items-center justify-center bg-background-base">
      <img src={clinicalResearchIcon} alt="" aria-hidden="true" class="size-16 rounded-2xl opacity-50 animate-pulse" />
    </div>
  )
}
